...
return [
    ...
    'ldap_activated_flag_help'  => 'This flag is used to determine whether a user can login to Bewsys dev and does not affect the ability to check items in or out to them.',
    ...
    'load_remote_help_text'		=> 'This Bewsys install can load scripts from the outside world.',
    ...
    'login_remote_user_custom_logout_url_help' => 'If a url is provided here, users will get redirected to this URL after the user logs out of Bewsys Dev. This is useful to close the user sessions of your Authentication provider correctly.',
    ...
    'show_images_in_email_help'   => 'Uncheck this box if your Bewsys Dev installation is behind a VPN or closed network and users outside the network will not be able to load images served from this installation in their emails.',
    'site_name'                 => 'Site Name',
    'slack'                     => 'Slack',
    ...
    'snipe_version'  			=> 'Bewsys Dev version',
    'support_footer'            => 'Support Footer Links ',
    'support_footer_help'       => 'Specify who sees the links to the Bewsys Dev Support info and Users Manual',
    'version_footer'            => 'Version in Footer ',
    'version_footer_help'       => 'Specify who sees the Bewsys Dev version and build number.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link to Bewsys Dev in Emails',
    'show_url_in_emails_help_text'      => 'Uncheck this box if you do not wish to link back to your Bewsys Dev installation in your email footers. Useful if most of your users never login. ',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'This will attempt to delete cached barcodes. This would typically only be used if your barcode settings have changed, or if your Bewsys Dev URL has changed. Barcodes will be re-generated when accessed next.',
