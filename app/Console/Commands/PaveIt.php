...
class PaveIt extends Command
{
     ...
     * @var string
     */
    protected $signature = 'bewsys:pave  {--force : Skip the interactive yes/no prompt for confirmation}';
